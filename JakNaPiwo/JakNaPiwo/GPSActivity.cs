...
namespace JakNaPiwo
{
    ...
    {
        static readonly string TAG = "X:" + typeof(GPSActivity).Name;
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            _get_address_button = FindViewById<Button>(Resource.Id.get_address_button);
        ...
        {
            _get_address_button.Click += AddressButton_OnClick;
        }
